...
HD_PWD='D:/Programowanie/Studia/Jezyki HDL/rs_232/rs_232.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs232_transceiver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs232_transceiver.tcl
