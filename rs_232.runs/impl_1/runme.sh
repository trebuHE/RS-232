...
HD_PWD='D:/Programowanie/Studia/Jezyki HDL/rs_232/rs_232.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rs232_transceiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rs232_transceiver.tcl -notrace
